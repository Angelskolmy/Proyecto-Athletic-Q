...
class Venta(models.Model):
    ...
    ultima_modificacion = models.DateTimeField(
        auto_now=True,
        db_column='ultima_modificacion',
        null=True,
        blank=True
    )

    observaciones_edicion = models.TextField(
        db_column='observaciones_edicion',
        null=True,
        blank=True
    )
    ...
    Numero_Transaccion = models.CharField(
        max_length=100,
        db_column='Numero_Transaccion',
        null=True,
        blank=True
    )

    Cedula_Vents = models.IntegerField(
        db_column='Cedula_Vents',
        null=True,
        blank=True
    )
    ...
    def __str__(self):
        return (
            ...
            f"Cedula_Vents {self.Cedula_Vents}"
        )