...
class Venta (models.Model):
    ...
    Numero_Transaccion= models.CharField(max_length=100, db_column='Numero_Transaccion', null=True) 
    Cedula_Vents= models.IntegerField( db_column='Cedula_Vents', null=True)
